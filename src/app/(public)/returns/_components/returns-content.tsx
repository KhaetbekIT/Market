...
export const ReturnsContent = () => {
	const steps = [
		...
		},
		{
			...
			description:
				"Сохраните оригинальную упаковку и все комплектующие товара",
		},
		{
			number: "3",
		...
		},
		{
			...
			description:
				"После проверки товара деньги вернутся на карту в течение 3-10 дней",
		},
	];
			...
			<section className="bg-primary text-primary-foreground py-16 md:py-24">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto leading-relaxed">
						Мы хотим, чтобы вы были довольны покупкой. Если что-то
						пошло не так, вы можете вернуть товар в течение 30 дней.
					</p>
				</div>
			</section>
						...
						<div className="space-y-6">
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										Можно вернуть в течение 30 дней, если
										сохранён товарный вид, упаковка и все
										этикетки. Стоимость обратной доставки
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										При обнаружении брака или дефекта
										возврат оформляется бесплатно. Мы
										компенсируем стоимость товара и
										доставки.
									</p>
								</div>
							</div>
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										Согласно законодательству РФ, некоторые
										категории товаров (нижнее бельё,
										парфюмерия, косметика) не подлежат
										возврату при отсутствии брака.
									</p>
								</div>
							</div>
						</div>
					...
					<div className="max-w-3xl mx-auto">
						...
						<div className="space-y-6">
							<div>
								...
								<p className="text-muted-foreground text-sm">
									После получения и проверки товара деньги
									возвращаются на карту в течение 3-10 рабочих
									дней в зависимости от вашего банка.
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground text-sm">
									Да, вы можете обменять товар на аналогичный
									другого размера или цвета при наличии на
									складе.
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground text-sm">
									Сфотографируйте повреждения и свяжитесь с
									нашей службой поддержки. Мы оперативно решим
									вопрос с возвратом или заменой.
								</p>
							</div>
						</div>
						...
						<div className="bg-muted rounded-lg p-6 text-center mt-8">
							<p className="text-sm text-muted-foreground">
								...
								возврате является вымышленной и служит только
								для демонстрации.
							</p>
						</div>
					</div>
