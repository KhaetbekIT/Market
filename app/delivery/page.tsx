        ...
        <section className="bg-primary text-primary-foreground py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto leading-relaxed">
              Мы предлагаем удобные способы доставки и оплаты, 
              чтобы покупки были максимально комфортными для вас.
            </p>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Сроки доставки зависят от выбранного способа и вашего региона. 
                  Для Москвы и Санкт-Петербурга доступна доставка на следующий день. 
                  Для других регионов срок составляет от 2 до 14 дней в зависимости 
                  от удалённости.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Статус заказа можно проверить в личном кабинете или по ссылке 
                  из письма-уведомления.
                </p>
              </div>

              <div className="bg-muted rounded-lg p-6 text-center">
                <p className="text-sm text-muted-foreground">
                  Это демо-версия интернет-магазина. Информация о доставке 
