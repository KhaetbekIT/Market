...
import { Heart, Minus, Plus, ShoppingCart, Star, Truck, RefreshCw, Shield } from 'lucide-react'
            ...
            <BreadcrumbList>
              ...
              {category && (
                <>
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href={`/catalog?category=${category.slug}`}>
                      {category.name}
                    </BreadcrumbLink>
                  </BreadcrumbItem>
                </>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className={cn('bg-transparent', favorite && 'text-accent border-accent')}
            ...
            <TabsContent value="description" className="mt-6">
              <div className="bg-card rounded-lg border border-border p-6">
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  Мы гарантируем высокое качество всех наших товаров. Если у вас возникнут 
                  вопросы или проблемы, наша служба поддержки всегда готова помочь.
                </p>
              </div>
            </TabsContent>
